...
const testimonials = [
    { id: 1, name: 'Shehzada Waseem', position: 'Property Developer', company: 'An-Naffy Enterprises', rating: 5, text: 'Bin Qasim Enterprises delivered our residential complex project with exceptional quality and professionalism. Their attention to detail and commitment to deadlines is remarkable.' },
    { id: 2, name: 'Khliq-o-Zaman', position: 'Business Owner', company: 'KKB Pvt Ltd', rating: 5, text: 'Working with Bin Qasim for our office building was a fantastic experience. They managed the entire project seamlessly and delivered beyond our expectations.' },
    { id: 3, name: 'Maqsood Ahmad', position: 'Property Developer', company: 'Tahir Builders', rating: 5, text: 'The industrial facility they built for us is outstanding. The quality of construction and their project management skills are top-notch. Highly recommended!' },
    { id: 4, name: 'Fatima Sheikh', position: 'Homeowner', company: 'Private Client', rating: 5, text: 'Our dream home became a reality thanks to their team. They were professional, responsive, and delivered exactly what we envisioned for our family.' }
];
                    ...
                    <div className="lg:col-span-8 min-h-[350px] relative">
                        <AnimatePresence mode="wait">
                            <motion.div
                                ...
                                className="w-full bg-white rounded-2xl shadow-xl p-8 md:p-10 border border-gray-100 relative"
                            >
                                {/* Quote Icon moved to right */}
                                <Quote className="absolute top-6 right-6 text-orange-500 opacity-20" size={60} />
