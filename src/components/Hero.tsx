...
const Hero = () => {
 ...
 >
 <div className="absolute inset-0 bg-brand-primary/80"></div> {/* Increased opacity of the primary blue overlay */}
 </div>
...
<h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight font-serif">
 ...
 <p className="text-xl text-gray-100 mb-8 max-w-2xl mx-auto leading-relaxed"> {/* Slightly lighter text for better contrast */}
 ...
 className="bg-brand-secondary hover:opacity-90 text-white px-8 py-4 rounded-lg font-medium text-lg transition-all duration-300 flex items-center justify-center group transform hover:scale-105"
 >
 Get Free Quote
 ...
 className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-brand-primary px-8 py-4 rounded-lg font-medium text-lg transition-all duration-300"
 >
 View Our Work
 </button>
 </div>
 ...
 <stat.icon className="mx-auto text-brand-secondary mb-2" size={32} />
